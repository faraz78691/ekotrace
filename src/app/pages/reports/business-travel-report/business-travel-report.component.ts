...
@Component({
  selector: 'app-business-travel-report',
  templateUrl: './business-travel-report.component.html',
  styleUrls: ['./business-travel-report.component.scss']
})
export class BusinessTravelReportComponent {
  ...
  modesType: any[] = [
    { id: 1, value: 'Flight Travel' },
    { id: 2, value: 'Other modes of transport' },
    { id: 3, value: 'Hotel Stay' },
  ...
  // }
    ...
    reportFormData.set('waste_generation', "0")
