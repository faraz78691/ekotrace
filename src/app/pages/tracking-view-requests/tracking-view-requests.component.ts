...
export class TrackingViewRequestsComponent {
    ...
    sendEntryForApproval() {
        ...
        if (this.selectedCategory == 1) {
            ...
            this.trackingService.newUpdateSCEntry(this.sendSCEntries).subscribe({
                next: (response) => {
                    console.log(response)
                    return
        ...
        if (this.selectedCategory == 2) {
            ...
            this.selectedEntry.forEach((element) => {
                this.selectedrefEntry = {
                    ...
                    reason: this.sendelement.reason,
                ...
                this.sendrefEntries.push(this.selectedrefEntry); // Add the new object to the sendEntries array
            });
        ...
        if (this.selectedCategory == 3) {
            ...
            this.selectedEntry.forEach((element) => {
                ...
                this.sendApprovalEntries.push(this.selectedfireEntry); // Add the new object to the sendEntries array
            });
        ...
        if (this.selectedCategory == 5) {
            ...
            this.selectedEntry.forEach((element) => {
                ...
                this.sendelecEntries.push(this.selectedelecEntry); // Add the new object to the sendEntries array
            });
        ...
        if (this.selectedCategory == 6) {
            ...
            this.selectedEntry.forEach((element) => {
                ...
                this.sendvehicleEntries.push(this.selectedvehicleEntry); // Add the new object to the sendEntries array
            });
        ...
        if (this.selectedCategory == 7) {
            ...
            this.selectedEntry.forEach((element) => {
                ...
                this.sendHSEntries.push(this.selectedHSEntry); // Add the new object to the sendEntries array
            });
    ...
    AcceptSingleEntry() {
        ...
        if (this.selectedCategory == 1) {
            this.sendSCelement = {
                id: entry.dataEntryID,
                manageDataPointSubCategoriesID: entry.subcategoryID,
                month: entry.month,
                note: entry.note,
                readingValue: entry.readingValue,
                sendForApproval: entry.sendForApproval,
                status: environment.approved,
                statusDate: new Date(),
                ...
                blendPercent: entry.blendPercent,
        ...
        if (this.selectedCategory == 2) {
            this.sendrefelement = {
                ...
                typeID: entry.typeID
                // cO2LeakagePerUnit: entry.cO2LeakagePerUnit,
                // capacity: entry.capacity,
                // leakagePerOfCapacity: entry.leakagePerOfCapacity,
                // airConnIDRef: entry.airConnIDRef
            };
            this.trackingService
        ...
        if (this.selectedCategory == 3) {
            this.sendfireelement = {
                ...
                gHGEmission: entry.ghgEmission,
                reason: entry.reason,
                numberOfExtinguisher: entry.numberOfExtinguisher,
                quantityOfCO2makeup: entry.quantityOfCO2makeup,
                fireExtinguisherID: entry.fireExtinguisherID,
                typeID: entry.typeID
            };
            this.trackingService
        ...
        if (this.selectedCategory == 5) {
            this.sendelecelement = {
                ...
                typeID: entry.typeID,
                electricityRegionID: entry.electricityRegionID
            };
            this.trackingService
        ...
        if (this.selectedCategory == 6) {
            this.sendvehicleelement = {
                ...
                gHGEmission: entry.ghgEmission,
                reason: entry.reason,
                noOfVehicles: entry.noOfVehicles,
                modeOfDE: entry.modeOfDE,
                value: entry.value,
                modeofDEID: entry.modeofDEID,
                vehicleTypeID: entry.vehicleTypeID,
                avgPeoplePerTrip: entry.avgPeoplePerTrip,
                totalnoOftripsPerVehicle: entry.totalnoOftripsPerVehicle,
                chargingPerc: entry.chargingPerc,
                typeID: entry.typeID
            };
            this.trackingService
