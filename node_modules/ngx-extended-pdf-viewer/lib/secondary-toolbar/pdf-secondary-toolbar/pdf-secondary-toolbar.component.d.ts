...
export declare class PdfSecondaryToolbarComponent implements OnChanges, AfterViewInit, OnDestroy {
    ...
    constructor(element: ElementRef, notificationService: PDFNotificationService, platformId: Object, pdfShyButtonService: PdfShyButtonService, sanitizer: DomSanitizer);
    onPdfJsInit(): void;
    updateUIState(): void;
    ...
    sanitizeHtml(html: string): import("@angular/platform-browser").SafeHtml;
