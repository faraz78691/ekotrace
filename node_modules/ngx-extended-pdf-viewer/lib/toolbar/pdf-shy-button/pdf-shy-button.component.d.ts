...
export declare class PdfShyButtonComponent implements OnInit, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PdfShyButtonComponent, "pdf-shy-button", never, { "primaryToolbarId": "primaryToolbarId"; "secondaryMenuId": "secondaryMenuId"; "cssClass": "cssClass"; "eventBusName": "eventBusName"; "l10nId": "l10nId"; "l10nLabel": "l10nLabel"; "title": "title"; "toggled": "toggled"; "disabled": "disabled"; "order": "order"; "action": "action"; "closeOnClick": "closeOnClick"; "image": "image"; }, {}, never, ["*"]>;
}
